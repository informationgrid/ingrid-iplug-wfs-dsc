...
function mapPreview(recordNode) {
    ...
    if (hasValue(gmlEnvelope)) {
        ...
        var addHtml = "<a href=\"http://atlas.wsv.res.bund.de/positionfinder/map/index.html?bwastr=" + BWSTR.trim() + "&kmwert=" + KM_ANF_D + "&abstand=0&zoom=15\" target=\"_blank\" style=\"padding: 0 0 0 0;\">" +
            "<div style=\"background-image: url(http://atlas.wsv.res.bund.de/tk/wms?VERSION=1.1.1&amp;REQUEST=GetMap&amp;SRS=EPSG:4326&amp;BBOX=" + BBOX +
            ...
            "<div style=\"background-image: url(http://atlas.wsv.res.bund.de/ienc/group/wms?VERSION=1.1.1&amp;REQUEST=GetMap&amp;SRS=EPSG:4326&amp;Transparent=True&amp;BBOX=" + BBOX +
